...
SELECT * FROM movie;
SELECT
SUM(CASE WHEN id IS NULL THEN 1 ELSE 0 END) AS "id NULL Count",
SUM(CASE WHEN title IS NULL THEN 1 ELSE 0 END) AS "title NULL Counts",
SUM(CASE WHEN year IS NULL THEN 1 ELSE 0 END) AS "year NULL Counts",
SUM(CASE WHEN date_published IS NULL THEN 1 ELSE 0 END) AS "date_published NULL Counts",
SUM(CASE WHEN duration IS NULL THEN 1 ELSE 0 END) AS "duration NULL Counts",
SUM(CASE WHEN country IS NULL THEN 1 ELSE 0 END) AS "country NULL Counts",
SUM(CASE WHEN worlwide_gross_income IS NULL THEN 1 ELSE 0 END) AS "worldwide_gross_income NULL Counts",
SUM(CASE WHEN languages IS NULL THEN 1 ELSE 0 END) AS "languages NULL Counts",
SUM(CASE WHEN production_company IS NULL THEN 1 ELSE 0 END) AS "production_company NULL Counts"
FROM movie;
...
SELECT * FROM movie;
SELECT year, COUNT(id) AS "Number of movies that year"
FROM movie
GROUP BY year;

SELECT * FROM movie;
SELECT MONTH(date_published) AS "month_number", count(id) AS "Number of movies"
FROM movie
...
-- Type your code below:
SELECT * FROM GENRE;
SELECT genre, COUNT(movie_id) AS "Number of Movies Produced"
FROM genre
GROUP BY genre
